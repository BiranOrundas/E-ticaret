...
<?php endif; ?>
<!-- products.php içindeki Form bölümünün altına ekleyin -->
<div class="mt-5 bg-light rounded p-4">
  <h6 class="mb-4">XML ile Toplu Ürün Yükleme</h6>
  <form method="post" enctype="multipart/form-data" action="import_xml.php">
    ...
    <button type="submit" class="btn btn-success">XML Yükle ve İçe Aktar</button>
  </form>
</div>

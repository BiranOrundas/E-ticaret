...
// 1) Ortak header ve sidebar dosyalarını yükle
require_once __DIR__ . '/includes/header.php';
require_once __DIR__ . '/includes/sidebar.php';

// 2) KPI değerlerini veritabanından çek
$today = date('Y-m-d');
...
// 3) Son 5 siparişi çek (en yeni 5)
...
<div class="content">
  ...
  <!-- Buraya grafik vs. diğer paneller gelebilir -->

</div>

<?php
// 4) Ortak footer dosyasını yükle
